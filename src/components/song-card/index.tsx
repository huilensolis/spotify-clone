...
export function SongCard({ song }: { song: Song }) {
	...
	return (
		<article className="flex w-full max-h-[calc(0.5rem*2+4rem)] gap-2 bg-transparent hover:md:bg-neutral-800 transition-all delay-75 md:p-2 md:pb-3 rounded-md cursor-pointer group relative">
			...
			<figure className="aspect-square h-full w-[calc(0.5rem*2+4rem)] absolute right-0 top-0 p-2 hidden group-hover:md:flex items-center justify-center">
